...
#'
#' Collection of functions for Gibbs sampling functions
#'
...
#' @param std standard deviation fro the normal distribution
#' @param lo lower end of the truncated distribution
#' @param hi upper end of the truncated distribution
#'
#' @export
#'
...
#'
#' @param miss_data missing data
#' @param method method of initialisation of the missing data
#'
#' @export
#'
...
#' @param x dataset
#' @param y dataset
#' @param y_miss y including missing data
#' @param y_real real y data
#' @param imp_model imputation model
#' @param lo lower end of truncated distribution
#' @param hi upper end of truncated distribution
#' @param iters_each number of iterations
#' @param gibbs gibbs sampling method
#'
#' @export
#'
...
#'
#' @param data_miss dataset
#' @param iters_each number of iterations
#' @param iters_all vector
#' @param initial imitialised data matrix
#' @param lo lower end
#' @param hi upper end
#' @param n_cores number of cores
#' @param imp_model imputation model
#' @param gibbs gibbs sampler
