...
#'
#' @param data data
#' @param mis_prop missing proportion
#'
#' @export
#'
...
#'
#' @param data_imp data imputation
#' @param data_miss data missing
#' @param data_true true data
#'
#' @export
#'
...
#'
#' @param data_c data to compare
#' @param mis_var missing variables
#' @param var_prop proportion of variables
#'
#' @export
#'
