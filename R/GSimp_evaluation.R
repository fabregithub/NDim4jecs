...
#'
#' Collection of functions for Imputation performance evaluation
#'

#' MNAR generation and imputation
#'
#' @param data_c data
#' @param mis_var_prop missing variable proportion
#' @param var_mis_prop variable missing proportion
#' @param impute_list list of imputation
...
#'
#' @param impute_results results of imputation
#' @param plot boolean indicator if plot is done or not
#' @param x label of x-axis
#' @param colors colours
#' @param shapes shapes
#'
#' @export
#'
...
#' Procrustes and plot
#'
#' @param impute_results imputation results
#' @param DR DR
#' @param lg lg
#' @param nPCs number of principal compornents
...
#'
#' @param imp_list imputation list
