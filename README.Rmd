...
**real_data** is a real-world targeted metabolomics dataset contains both FFAs and BAs.

**data_sim** is the simulated dataset (details could be found in **simulation_generation.Rmd**).

**targeted_data** is a targeted LC/MS data with missing values.

**untargeted_data** is an untargeted GC/MS data with missing values after manually missing retrieval.
...
You can install the development version of GSimp4jecs [GitHub](https://github.com/) with:
...
### GSimp in real-world missing data sets
#### Data sets
...
```{r, out.width='100%', fig.align='center', fig.cap='The following analyses are tested on post-missing retrieval untargeted GC/MS dataset and targted LC/MS dataset.'}
knitr::include_graphics('man/figures/README/compare.png')
```
...
```{r, out.width='100%', fig.align='center', fig.cap='Each black cell represents a missing value.'}
knitr::include_graphics('man/figures/README/Missmap_untargeted.png')
```
...
```{r, out.width='100%', fig.align='center', fig.cap='PCA-Procrustes between GSimp (points) and kNN-TN (targets)'}
...
```{r, out.width='100%', fig.align='center', fig.cap='PCA-Procrustes between GSimp (points) and QRILC (targets)'}
knitr::include_graphics('man/figures/README/unnamed-chunk-4-2.png')
```
...
```{r, out.width='100%', fig.align='center', fig.cap='PCA-Procrustes between GSimp (points) and HM (targets)'}
knitr::include_graphics('man/figures/README/unnamed-chunk-4-3.png')
```

##### Targeted LC/MS dataset
...
```{r, out.width='100%', fig.align='center', fig.cap='Each black cell represents a missing value.'}
knitr::include_graphics('man/figures/README/Missmap_targeted.png')
```
...
```{r, out.width='100%', fig.align='center', fig.cap='PCA-Procrustes between GSimp (points) and QRILC (targets)'}
knitr::include_graphics('man/figures/README/unnamed-chunk-5-2.png')
```
...
```{r, out.width='100%', fig.align='center', fig.cap='PCA-Procrustes between GSimp (points) and HM (targets)'}
knitr::include_graphics('man/figures/README/unnamed-chunk-5-3.png')
```

### GSimp in simulated data sets
...
```{r, out.width='100%', fig.align='center', fig.cap='SOR of three imputation methods with the increasing number of missing variables'}
...
```{r, out.width='100%', fig.align='center', fig.cap='PCA-Procrustes results of three imputation methods with the increasing number of missing variables'}
knitr::include_graphics('man/figures/README/unnamed-chunk-9-2.png')
```
...
```{r, out.width='100%', fig.align='center', fig.cap='PLS-Procrustes results of three imputation methods with the increasing number of missing variables'}
knitr::include_graphics('man/figures/README/unnamed-chunk-9-3.png')
```
...
```{r, out.width='100%', fig.align='center', fig.cap='Correlation of T-test p-values of three imputation methods with the increasing number of missing variables'}
knitr::include_graphics('man/figures/README/unnamed-chunk-9-4.png')
```
...
```{r, out.width='100%', fig.align='center', fig.cap='TPR (p-value=.05) of three imputation methods with the increasing number of missing variables'}
knitr::include_graphics('man/figures/README/unnamed-chunk-9-5.png')
```
...
```{r, out.width='100%', fig.align='center', fig.cap='TPR (p-value=.01) of three imputation methods with the increasing number of missing variables'}
knitr::include_graphics('man/figures/README/unnamed-chunk-9-6.png')
```


### GSimp with different iterations
...
```{r, out.width='100%', fig.align='center', fig.cap='SOR of different interations of GSimp with the increasing number of missing variables'}
knitr::include_graphics('man/figures/README/unnamed-chunk-12-1.png')
```
